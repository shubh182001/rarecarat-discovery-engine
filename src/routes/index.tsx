    ...
    <div className="relative">
      ...
      {!chatOpen && (
        <button
          ...
          className="fixed bottom-6 left-6 z-40 inline-flex items-center gap-2 rounded-full bg-gold px-5 py-3 text-sm font-semibold text-gold-foreground shadow-[var(--shadow-elegant)] transition-transform hover:-translate-y-0.5"
        >
